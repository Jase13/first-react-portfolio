...
const Portfolio = () => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-pink-400 ">
        <div className="pb-8">
          ...
          {portfolios.map(({ id, src }) => (
            <div key={id} className="shadow-md shadow-pink-600 rounded-lg">
              ...
              <div className="flex items-center justify-center">
                <button className="w-1/2 px-6 py-3 m-4 text-pink-400 duration-200 hover:scale-105">
                  Demo
                </button>
                <button className="w-1/2 px-6 py-3 m-4 text-pink-400 duration-200 hover:scale-105">
                  Code
